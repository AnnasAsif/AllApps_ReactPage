...
export class SmartyMenApp extends Component {
    constructor(props){
        super(props);
    ...
    async loadframes(bundle){
      ...
      await fetch(`http://161.97.164.28:9005/api/assets/getframes?tag=${bundle}`)
        ...
        <div style={{display:'flex', flexDirection:'row'}}>
        {
            this.props.data.map(subcategory=>(
                ...
                <span style={{width:'20%'}}>  
                  ...
                  &nbsp;&nbsp;
                  <input type='submit' value={subcategory.name} onClick={()=>{this.loadframes(subcategory.name)}}/>
                  &nbsp;&nbsp;
                </span>
            ))
        }
